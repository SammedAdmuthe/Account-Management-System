...
StockAccount::StockAccount(double initialBalance){
    ...
    getStockPortfolioInfo("../../../../QTAMS/FinalProject_gui_Sammed/Stock_Portfolio_Info.txt");
...
void StockAccount::displayCurrentPortfolio() const{
    ...
    std::ifstream file("../../../../QTAMS/FinalProject_gui_Sammed/Stock_Portfolio_Info.txt");
    std::string line;
...
double StockAccount::displayPriceOfStock(std::string symbol) {
    ...
    StockData randomStock = (arc4random() % 2 == 0) ? readStockData("../../../../QTAMS/FinalProject_gui_Sammed/Result_1.txt", symbol) : readStockData("../../../../QTAMS/FinalProject_gui_Sammed/Result_2.txt", symbol);
...
void StockAccount::recordTransaction(const std::string& type, const std::string& symbol, int shares, double price) {
    std::ofstream file("../../../../QTAMS/FinalProject_gui_Sammed/stock_transaction_history.txt", std::ios::app);
...
void StockAccount::recordWithdrawal(double totalCost) {
    std::ofstream file("../../../../QTAMS/FinalProject_gui_Sammed/bank_transaction_history.txt", std::ios::app);
...
void StockAccount::viewTransactionHistory() {
    std::string filename = "../../../../QTAMS/FinalProject_gui_Sammed/stock_transaction_history.txt";
    std::ifstream file(filename);
    std::string line;
